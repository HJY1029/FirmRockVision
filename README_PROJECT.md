...
基于机器学习的智能网络安全威胁检测与分析平台，使用UNSW-NB15数据集进行网络流量异常检测、攻击类型识别和深度威胁分析。

## 项目概述

本项目实现了一个完整的智能网络入侵检测与威胁分析系统，具备以下核心功能：
...
### 4. 模型与性能
- **多模型支持**：Random Forest, XGBoost, LightGBM
- **模型对比**：对比多种机器学习算法的性能
- **可视化分析**：生成详细的性能评估图表
